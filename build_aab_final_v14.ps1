...
# Version: 1.1.4+24 (Updated Version)

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "🚀 Building Car Wash App AAB File" -ForegroundColor Yellow
Write-Host "Version: 1.1.4+24 (Updated Version)" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "Building version 1.1.4+24 (Updated Version)..." -ForegroundColor Green
Write-Host ""
