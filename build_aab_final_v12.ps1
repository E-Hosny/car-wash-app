...
Write-Host "Building Car Wash App AAB File - Version 1.0.7+12 (Demo User Added)" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
...
Write-Host "Building version 1.0.7+12 (Demo User Added)..." -ForegroundColor Cyan
Write-Host ""
try {
...
Write-Host "📱 Version: 1.0.7+12 (Demo User Added)" -ForegroundColor Cyan
Write-Host "📊 Expected file size: 15-25 MB" -ForegroundColor Cyan
Write-Host ""
Write-Host "🚀 Ready for Google Play upload!" -ForegroundColor Green
Write-Host ""
Write-Host "Demo User Info:" -ForegroundColor Yellow
Write-Host "📞 Phone: 971999999999" -ForegroundColor White
Write-Host "🔑 OTP Code: 0000" -ForegroundColor White
Write-Host ""
