                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return RadioListTile<int>(
                      ...
                      title: Text('${car['brand']['name']} ${car['model']['name']}'),
                      subtitle: Text('Year: ${car['year']['year']} • Color: ${car['color']}'),
                      onChanged: (val) {
                        setState(() {
                          selectedCarId = val;
                        });
      ...
      children: [
        ...
        Container(
          ...
          child: ElevatedButton.icon(
            ...
            icon: Icon(selectedDateTime != null ? Icons.access_time : Icons.schedule),
            label: Text(
              selectedDateTime != null
            ...
            style: ElevatedButton.styleFrom(
              foregroundColor: Colors.white,
              backgroundColor: selectedDateTime != null ? Colors.green : Colors.black,
